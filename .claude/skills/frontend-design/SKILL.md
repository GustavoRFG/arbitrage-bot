...
Focus on:
- **Typography**: Choose fonts that are beautiful, unique, and interesting. Avoid generic fonts like Arial and Inter; opt for distinctive choices that elevate the frontend aesthetics.
...
NEVER use generic AI aesthetics: overused fonts (Inter, Roboto, Arial), cliched color schemes (purple gradients on white), predictable layouts, cookie-cutter design.

Remember: commit fully to a distinctive vision and execute it with precision.
